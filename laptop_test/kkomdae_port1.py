...
class TestApp(ttkb.Window):
    ...
    def _init_variables(self) -> None:
        ...
        self.status_images = {
            ...
            "USB테스트 전":{
                1:self.create_text_image("①", (40, 30), self.notosans_path, 16, (255, 0, 0), align_left=False),
                2:self.create_text_image("②", (40, 30), self.notosans_path, 16, (255, 0, 0), align_left=False),
                3:self.create_text_image("③", (40, 30), self.notosans_path, 16, (255, 0, 0), align_left=False)
            },
            "USB테스트 완료":{
            ...
            #     3:self.create_text_image("③", (40, 30), self.notosans_path, 16, (0, 128, 0), align_left=False),
                ...
                2:self.create_text_image("연결 완료", (120, 30), self.notosans_path, 16, (0, 128, 0), align_left=True),
                3:self.create_text_image("연결 완료", (120, 30), self.notosans_path, 16, (0, 128, 0), align_left=True)
            },
        }
        # 버튼 이미지 생성
        self.button_images = {
